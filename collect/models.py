...
class TeamFileUpload(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, related_name='team_file_uploads')
    task_id = models.CharField(verbose_name='celery_task_id', max_length=150, blank=True)
    file = models.FileField()
...
class Team(models.Model):
    file_upload = models.ForeignKey('TeamFileUpload', on_delete=models.CASCADE, related_name='teams')
